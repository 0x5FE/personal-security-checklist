...
**[Etopa](https://play.google.com/store/apps/details?id=de.ltheinrich.etopa)** (Android)  | free and open source (FOSS) app for two-factor-authentication (2FA), which runs as a web server and can be accessed using a web browser or using an Android app.
